...
public class TestIdioma {
	...
	// Atributos
		...
		public void informarAtributos(String idioma) {
			...
			UtilsFitxers.llegeixF(nomFichero);
						 			
			for (String lineaEntrada : UtilsFitxers.llegeixF(nomFichero)) {
				
				String[] lineaConIndice  = UtilsStrings.separaEnParaules(lineaEntrada,";");
					...
					switch (lineaDatos) {
				      ...
				      case "002":
				    	  String[] vectorDiasSemana  = 
				    			  UtilsStrings.separaEnParaules(lineaConIndice[+1],",");
		...
		//Constructor
		public TestIdioma(String idioma){
		...
		public static void main(String[] args){
			...
			TestIdioma idioma = new TestIdioma(config.getIdiomaIn());
			TestIdioma idioma2 = new TestIdioma("Cat");
			TestIdioma idioma3 = new TestIdioma("XXX");
