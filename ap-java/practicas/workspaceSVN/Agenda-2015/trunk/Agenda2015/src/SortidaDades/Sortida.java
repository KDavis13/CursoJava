...
public class Sortida{
        ...
        // Atributos
        private static Idioma idiomaIn; //Objeto de Idioma de entrada
        private static Idioma idiomaOut; //Objeto de Idioma de salida
        private static Data fecha; //Objeto que contiene todo la info de fechas
        ...
        private static String[][] dades; //Este Array simula el Array de datos
        
        
        private static int contSalas = 0;
        ...
        // Constructor
        //public Sortida(Idioma idiomaIn, Idioma idiomaOut, Data fecha, String[][] array) {
        public Sortida(Idioma idiomaIn, Idioma idiomaOut, Data fecha, String[][] array, String sala) {    
        	contSalas++;
            ...
            //for (int i = 0; i < salas.length; i++) {
                    ...
                    Imprime texto = new Imprime(dades, idiomaIn, idiomaOut, fecha, nombre);
