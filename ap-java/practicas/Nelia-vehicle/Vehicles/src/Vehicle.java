...
public class Vehicle {
	...
	public Vehicle(String mar, String mod, int any, String prov_matr,int num_matr, String lletres_matr, double con){
		this.marca = mar;
		this.model = mod;
		this.any = any;
		this.matricula = new Matricula(prov_matr, num_matr,lletres_mat);
		this.consum = con;
	}

	public static void main(String[] args) {
		Vehicle v1 = new Vehicle("Opel","Corsa",2013,"BA",4546,"HVJ",5.2F);
		
		System.out.println(v1.autonomia(50F));
