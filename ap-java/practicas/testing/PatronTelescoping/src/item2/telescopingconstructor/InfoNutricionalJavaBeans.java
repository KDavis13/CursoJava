...
public class InfoNutricionalJavaBeans {
	...
	public InfoNutricionalJavaBeans() {
	}
	...
	public static void main(String[] args) {
		...
		InfoNutricionalJavaBeans cocacola = new InfoNutricionalJavaBeans();
		...
		InfoNutricionalJavaBeans orchata = new InfoNutricionalJavaBeans();
