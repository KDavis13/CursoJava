...
public class ProbarTriangulo {
	...
	public static void main(String[] args)  {
		...
		//System.out.println("El perímetro del triángulo 1 es " + tri1.perimetro());
		//System.out.println("El perímetro del triángulo 2 es " + tri2.perimetro());

		Triangulo tri3 = new Triangulo(6.1, 8.4, 6.1);

		//System.out.println("el perímetro del triángulo 3 es " + tri3.perimetro());
		...
		for(int i = 0; i<triangulos.length; i++){
			if(i == 0 || i == 4 || i == 5){
				System.out.println("Soy un " + triangulos[i].getClass().getSimpleName() +
						", y mi perímetro es " + triangulos[i].perimetro());
			}
		}
