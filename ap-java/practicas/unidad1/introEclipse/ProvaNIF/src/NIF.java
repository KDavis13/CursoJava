...
public class NIF extends DNI {
	...
	/**
	 * Calcula la lletra corresponent al DNI guardat, i modifica l'atribut
	 * lletra convenientment.
	 */
	 ...
	 * cas, la representació en forma de string coincideix amb l'atribut
	 * DNI+NIF.
	 * 
	 * @return a string NIF
	 */
	 ...
	 * Java. En aquest cas el mètode llegeix de l'entrada estàndard una cadena
	 * de caràcters, crea un NIF amb aquesta cadena com a DNI, i escriu la
