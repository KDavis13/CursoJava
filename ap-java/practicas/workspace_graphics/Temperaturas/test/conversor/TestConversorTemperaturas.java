...
public class TestConversorTemperaturas {
	...
	public static class TestConversorTemperaturasBateria {
		...
		public static Collection<Object[]> datos() {
			return Arrays.asList(new Object[][] { { 0.0, 32.0, 0.0, 0.0 },
					{ 15, 59.0, 12.0, 0.0 }, { 30, 86.0, 24.0, 0.0 },
					{ 50, 122.0, 40.0, 0.0 }, { 90, 194.0, 72.0, 0.0 } });
		}
		...
		public void testTemperaturaNoValidaFahrenheit()
				throws TemperaturaNoValidaException {
